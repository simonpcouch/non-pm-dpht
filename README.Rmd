...
This repository contains source code to carry out the power analyses of several differentially private hypothesis testing algorithms from the 2019 paper *Differentially Private Nonparametric Hypothesis Testing* [1], published in the Proceedings of the 26th ACM Conference on Computer and Communications Security.
...
[1] Simon Couch, Zeki Kazan, Kaiyan Shi, Andrew Bray, and Adam Groce. "Differentially Private Nonparametric Hypothesis Testing." In *Proceedings of the 26th ACM Conference on Computer and Communications Security*. 2019.  
